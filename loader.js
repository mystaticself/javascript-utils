...
export default class Loader
{
    ...
    loadGeometryJSON(fileObj)
    {
        ...
        loader.load(fileObj.file, geometry => {
    ...
    loadCollada(fileObj)
    {
        ...
        loader.load(fileObj.file, collada => {
            loadInfo[fileObj.id].loaded = loadInfo[fileObj.id].total;
    ...
    loadTexture(fileObj)
    {
        ...
        loader.load(fileObj.file, texture => {
            loadInfo[fileObj.id].loaded = loadInfo[fileObj.id].total;
    ...
    loadCubemap(fileObj)
    {
        ...
        loader.load(fileObj.file, cubemapTexture => {
            loadInfo[fileObj.id].loaded = loadInfo[fileObj.id].total;
            files.textures[fileObj.id] = cubemapTexture;
            numLoaded++;
            loadCheck();
        }, xhr => {
            loadInfo[fileObj.id].loaded = xhr.loaded;
